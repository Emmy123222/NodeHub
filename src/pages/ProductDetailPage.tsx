        ...
        >
          <div className="text-[#0D1B2A] p-7">
            ...
            <p className="flex items-center text-lg">
              <span className="mr-2">🚀</span> Best For: Running validator nodes
              (Ethereum, Solana, Bitcoin)
            </p>

            <p className="flex items-center text-lg">
              <span className="mr-2">✅</span> Pre-installed Software: DAppNode
              OS
            </p>
          ...
          <div className="p-7 text-black">
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center">
                <span className="text-green-500 mr-2">✅</span>
                <span>Future-proof - Supports major blockchain protocols</span>
              </li>
            </ul>
